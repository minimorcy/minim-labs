...
export const ui = {
  es: {
    ...
    "hub.subtitle": "Punto de entrada a los proyectos alojados bajo subdominios de minim-labs.dev.",
    "status.live": "Activo",
  ...
  en: {
    ...
    "hub.subtitle": "Entry point to the projects hosted under minim-labs.dev subdomains.",
    "status.live": "Live",
